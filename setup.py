...
setup(
    ...
    url='https://github.com/physxx/9bot',

    # Author details
    author='Loic Schwab & Luc Wunderlin',
    author_email='loic.schwab@he-arc.ch & luc.wunderlin@he-arc.ch',
    ...
    keywords='9gag, bot, slackbot, fun',
